export const cs = {
  ...
  admin: {
    ...
    officeSubscriptions: 'Kanceláře',
    officeSubscriptionPlans: 'Tarify',
    officeSubscriptionInquiries: 'Poptávky',
    noOfficeSubscriptionInquiries: 'Zatím žádné poptávky.',
    priceMonthlyCzk: 'Cena bez závazku (Kč/měsíc)',
    priceYearlyCommitmentCzk: 'Cena s roční smlouvou (Kč/měsíc)',
    perMonth: '/ měsíc',
    perMonthYearly: '/ měsíc (roční smlouva)',
