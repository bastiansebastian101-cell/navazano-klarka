export const cs = {
  ...
  admin: {
    ...
    officeSubscriptions: 'Květinové předplatné',
    officeSubscriptionPlans: 'Tarify',
    officeSubscriptionInquiries: 'Poptávky',
    noOfficeSubscriptionInquiries: 'Zatím žádné poptávky.',
    price1MonthCzk: 'Cena na 1 měsíc (Kč, celkem)',
    price2MonthCzk: 'Cena na 2 měsíce (Kč, celkem)',
    perOneMonth: '/ 1 měsíc',
    perTwoMonths: '/ 2 měsíce',
    markContacted: 'Označit jako kontaktováno',
    contactedLabel: 'Kontaktováno',
  },
  footer: {
  ...
  officeSubscription: {
    ...
    intro: 'Čerstvé květiny doručované každý týden, které povýší váš domov i pracovní prostor.',
    deliveryPoint: 'Doručení 1x týdně',
    vasePoint: 'Profesionální aranžmá od zkušených floristek',
    freeDeliveryPoint: 'Doprava zdarma v ceně',
    oneMonth: '1 měsíc',
    twoMonths: '2 měsíce',
    perOneMonth: '1 měsíc',
    perTwoMonths: '2 měsíce',
    ...
    messagePlaceholder: 'Cokoliv, co bychom měli vědět…',
    submit: 'Odeslat poptávku',
    submitting: 'Odesílám...',
    successTitle: 'Děkujeme!',
    successMessage: 'Vaši poptávku jsme přijali. Ozveme se vám co nejdříve a domluvíme se na platbě a doručení.',
    genericError: 'Něco se nepovedlo. Zkuste to prosím znovu.',
  },
  reviewForm: {
