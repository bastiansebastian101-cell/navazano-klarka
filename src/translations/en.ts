...
export const en: Translations = {
  ...
  admin: {
    ...
    featuredOnHome: 'Show on homepage',
    onHomeLabel: 'On homepage',
    moveToHome: 'Move to homepage',
    removeFromHome: 'Remove from homepage',
    variants: 'Variants (optional)',
    variantsHint: 'E.g. different weights or colors — each variant has its own price.',
    variantLabelPlaceholder: 'E.g. 250g',
    ...
    enterCostHint: 'Enter the flower and/or wrap cost above to include it in the calculation.',
    flowerCost: 'Flower cost (Kč)',
    wrapCost: 'Wrap/packaging cost (Kč)',
    salePrice: 'Sale price (Kč, VAT incl.)',
    commissionLabel: 'Commission',
    dphLabel: 'VAT (21%)',
    commissionAmountLabel: 'Platform commission',
    costLabel: 'Cost (flowers + wrap)',
    profitLabel: 'Profit',
    channels: {
      website: 'Own website',
      foodora: 'Foodora',
    ...
    officeSubscriptions: 'Flower subscription',
    officeSubscriptionPlans: 'Plans',
    officeSubscriptionInquiries: 'Inquiries',
    noOfficeSubscriptionInquiries: 'No inquiries yet.',
    price1MonthCzk: '1-month price (Kč, total)',
    price2MonthCzk: '2-month price (Kč, total)',
    perOneMonth: '/ 1 month',
    perTwoMonths: '/ 2 months',
  ...
  officeSubscription: {
    ...
    intro: 'Fresh blooms delivered weekly to elevate your home or workspace.',
    deliveryPoint: 'Delivered once a week',
    vasePoint: 'Professional arrangement by expert designers',
    freeDeliveryPoint: 'Free weekly delivery included',
    oneMonth: '1 month',
    twoMonths: '2 months',
    perOneMonth: '1 month',
    perTwoMonths: '2 months',
    ...
    selected: 'Selected',
    formTitle: 'No-obligation inquiry',
    ...
    submitting: 'Sending...',
    successTitle: 'Thank you!',
    successMessage: "We've received your inquiry. We'll be in touch soon to arrange payment and delivery.",
    genericError: 'Something went wrong. Please try again.',
  },
  reviewForm: {
