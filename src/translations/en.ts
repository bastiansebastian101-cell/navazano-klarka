...
export const en: Translations = {
  ...
  admin: {
    ...
    officeSubscriptions: 'Offices',
    officeSubscriptionPlans: 'Plans',
    officeSubscriptionInquiries: 'Inquiries',
    noOfficeSubscriptionInquiries: 'No inquiries yet.',
    priceMonthlyCzk: 'No-commitment price (Kč/month)',
    priceYearlyCommitmentCzk: 'Yearly-commitment price (Kč/month)',
    perMonth: '/ month',
    perMonthYearly: '/ month (yearly commitment)',
